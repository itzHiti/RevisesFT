...
public class FinishReasonArgument extends ArgumentResolver<CommandSender, String> {
    public static final String KEY = "finish-reason";
    ...
    public SuggestionResult suggest(Invocation<CommandSender> invocation, Argument<String> argument, SuggestionContext context) {
        return SuggestionResult.of(reviseManager.getFinishReasonSuggestions())
